        ...
        <table data-module="module-2" width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td data-bgcolor="bg-module" bgcolor="#eaeced"><table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="img-flex"><img src="{{ url('img/email-headers/email_header.gif') }}" style="vertical-align:top;" width="600" height="auto" alt="" />                 
                </td>
              </tr>
              <tr>
                    ...
                    <td valign="middle" class="bg_black footer email-section">
                      <table width="100%" style="font:14px/20px Arial, Helvetica, sans-serif; color:#333; font-weight:bold">
                          ...
                          <tr>
                              <td valign="top">                               
                                {!! Settings()->address !!}<br />
                                <img src="{{ url('img/phone-icon.png') }}" style="vertical-align:top;" width="20" height="20" alt="Phone" /> {{ Settings()->phone }}</a>
                              </td>
                              <td valign="top"><a href="tel:{{ Settings()->phone }}">
                                <a href="mailto:{{ Settings()->email }}"><img src="{{ url('img/email-icon.png') }}" style="vertical-align:top;" width="20" height="20" alt="Email" /> {{ Settings()->email }}</a>
                              </td>
                          </tr>
                      </table>
                    </td>
