        ...
        <table data-module="module-2" width="100%" cellpadding="0" cellspacing="0">
          <tr>
            <td data-bgcolor="bg-module" bgcolor="#eaeced"><table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="img-flex">
				@if(@$email_buyer_seller=='BUYER REGISTER')
					<img src="{{ url('img/email-headers/buyer_email_header.gif') }}" style="vertical-align:top;" width="600" height="auto" alt="" />
				@endif
				@if(@$email_buyer_seller=='SELLER REGISTER')
					<img src="{{ url('img/email-headers/seller_email_header.gif') }}" style="vertical-align:top;" width="600" height="auto" alt="" />
				@endif
				</td>
              </tr>
              <tr>
