<div class="contact-panel" id="contact-panel" data-toggler=".is-active">
  ...
  <form name="contactsend_form" id="contactsend_form" action="{{url('contact_send')}}">
    ...
    <div class="contact-panel-actions">
      <button type="button" class="cancel-button" data-toggle="contact-panel" style="background:#2d86d5">Nevermind</button>
...
@push('after-scripts')
 <script type="text/javascript">
   ...
   $("#contactsend_form .cancel-button").click(function(){
