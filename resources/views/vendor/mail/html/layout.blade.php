                  ...
                  <tr>
                    <td valign="middle" class="bg_black footer email-section">
                      <table width="100%" style="font:14px/20px Arial, Helvetica, sans-serif; color:#333; font-weight:bold">
                          ...
                          <tr>
                              <td valign="top" style="text-align:left">{!! Settings()->address !!}</td>
                              <td valign="top"><table width="100%" border="0" cellspacing="5" cellpadding="5">
                              <tr><td><a href="tel:{{ Settings()->phone }}" style="margin-bottom:10px;"><img src="{{ url('img/phone-icon.png') }}" style="vertical-align:top;" width="20" height="20" alt="Phone" /> {{ Settings()->phone }}</a></td></tr>
                              <tr><td><a href="mailto:{{ Settings()->email }}"><img src="{{ url('img/email-icon.png') }}" style="vertical-align:top;" width="20" height="20" alt="Email" /> {{ Settings()->email }}</a></td></tr>
                            </table></td>
                          </tr>
                      </table>
                    </td>
              ...
              <td data-bgcolor="bg-module" bgcolor="#eaeced"><table class="flexible" width="600" align="center" style="margin:0 auto;" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="footer" style="padding:0 0 10px;"><table width="100%" cellpadding="0" cellspacing="0">
                    <tr><th colspan="2" style="padding:5px 0 5px;"></td></tr>
                    ...
                    <th class="thead" width="200" align="right" style="font:12px/16px Arial, Helvetica, sans-serif; color:#797c82; padding:0 0 10px;vertical-align:top;">
