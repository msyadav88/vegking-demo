...
@section('title', 'Seller Deliveries Card View :: '.app_name())
@push('after-styles')
<style>       
    .carousel-indicators
    {
    ...
    <div class="row" id = "viewcards">
        <div class="col-md-2 col-sm-12 mb-4">
            <h4 class="card-title mb-0">
                ...
                <a href="{{ route($route_pre.'.deliveries.index') }}" class="btn btn-info btn-md ml-1" title="Seller Deliveries List View" data-toggle="tooltip" ><i class="fas fa-list"></i></a>
            </h4>
        </div><!--col-->  
        <div class="col-md-10 ">
            <div class="row">
