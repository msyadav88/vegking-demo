...
<?php //echo "<pre>"; print_r($user); print_r($logged_in_buyer); exit('here');  ?>
@extends('backend.layouts.app')

@section('title', __('Edit Profile'). ' | ' . __('Edit Buyer'))
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <div class="checkbox d-flex align-items-center">
                                                {{ html()->label(
                                                            html()->checkbox('contact_email',@$buyer->contact_email)
                                                                    ->class('switch-input')
                                                                    ->id('contact_email')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10 row">
                                            <div class="col-md-1">
                                                ...
                                                {{ html()->label(
                                                            html()->checkbox('contact_whatsapp',@$buyer->contact_whatsapp)
                                                                    ->class('switch-input')
                                                                    ->id('contact_whatsapp')
                                                                . '<span class="switch-slider" data-checked="on" data-unchecked="off"></span>')
                                                            ->class('switch switch-label switch-pill switch-primary mr-2')
...
{{ html()->closeModelForm() }}
@php
$url = route('buyer.user.edit', $buyer->id);
$redirecturl = route('buyer.user.edit', Auth()->user()->id);
@endphp
@endsection
