...
<div class="card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-sm-8">
                <form action="{{ route('admin.user-ips.usertracking') }}" name="filter_matches">
                    <div class="row">
                        <div class="col-md-4">
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="table-responsive">
                   <table class="table table-bordered data-table usertracking_tbl" id="usertracking_tbl">
                        <thead>
                        <tr>
                            <th>ID</th>
                            <th>User Id</th>
                        ...
                        <tr id="filter">
                            ...
                            <th data-title="IP"></th>
                            <th data-title="ThisUrl"></th>
                            <th data-title="Button"></th>
                            <th data-title="Name"></th>
                            <th data-title="FromUrl"></th>
                            <th data-title="ToUrl"></th>
                            <th data-title="Data"></th>
...
<script type="text/javascript">
    $(function () {
        ...
        $('#usertracking_tbl tr:eq(1) th').each( function () {
        ...
        var table = $('.data-table').DataTable({
            ...
            //scrollX: true,
            //responsive: false,
            ajax: "{{ route('admin.user-ips.usertracking') }}?@if(isset($_GET['from_date']))from_date={{@$_GET['from_date']}}&to_date={{@$_GET['to_date']}}@endif",
            columns: [
                ...
                {data: 'fromUrl', name: 'fromUrl'},
                {data: 'toUrl', name: 'toUrl'},
                {data: 'data', name: 'data'},
                {data: 'date', name: 'date'},
            ]
        });
