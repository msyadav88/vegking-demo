...
@section('title', 'User Visits'. ' | '.app_name() )
        ...
        <div class="row">
            <div class="col-sm-4">
                <h4 class="card-title mb-0">
                  User Visits <small class="text-muted"></small>
                </h4>
            </div><!--col-->
            <div class="col-sm-8">
                <form action="{{ route('admin.analytics.user-visits') }}" name="filter_matches">
                    <div class="row">
                        <div class="col-md-4">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            var table = $('.data-table').DataTable({
                ...
                //scrollX: true,
                //responsive: false,
                ajax: "{{ route('admin.analytics.user-visits') }}?@if(isset($_GET['from_date']))from_date={{@$_GET['from_date']}}&to_date={{@$_GET['to_date']}}@endif",
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'user_id', name: 'user_id'},
                    {data: 'country', name: 'country'},
                    {data: 'ip', name: 'ip'},
                    {data: 'thisUrl', name: 'thisUrl'},
