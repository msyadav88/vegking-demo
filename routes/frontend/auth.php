...
Route::group(['namespace' => 'Auth', 'as' => 'auth.'], function () {
     ...
     Route::get('whatsapp/verify/{token}', [ConfirmAccountController::class, 'whatsappVerify'])->name('whatsapp.verify');
     Route::get('whatsapp/verify/resend/{uuid}', [ConfirmAccountController::class, 'sendWhatsappVerification'])->name('whatsapp.verify.resend');
