...
//        'da' => ['da', 'da_DK', false],
        'de' => ['de', 'de_DE', false,'img/german.jpg'],
//        'el' => ['el', 'el_GR', false],
        'en' => ['en', 'en_US', false,'img/english.jpg'],
        'es' => ['es', 'es_ES', false,'img/spain.jpg'],
 //       'fa' => ['fa', 'fa_IR', true],
        'fr' => ['fr', 'fr_FR', false,'img/france.jpg'],
//        'he' => ['he', 'he_IL', true],
        //'id' => ['id', 'id_ID', false,'img/indonesia.jpg'],
/*        'it' => ['it', 'it_IT', false],
        'ja' => ['ja', 'ja-JP', false],
        'nl' => ['nl', 'nl_NL', false],
        'no' => ['no', 'no_NO', false],
        'pt_BR' => ['pt_BR', 'pt_BR', false],*/
        'pl' => ['pl', 'pl', false,'img/polish.png'],
        'ru' => ['ru', 'ru-RU', false,'img/russian.jpg'],
        // 'sv' => ['sv', 'sv_SE', false],
        // 'th' => ['th', 'th_TH', false],
        // 'tr' => ['tr', 'tr_TR', false],
        // 'uk' => ['uk', 'uk-UA', false],
